...
from transformers import Trainer, TrainingArguments, LlamaForCausalLM, LlamaTokenizer, LlamaConfig
...
def init_tokenizer(args, config_dict):
    ...
    tokenizer = LlamaTokenizer.from_pretrained(config_dict['model_name'])
